...
public class BasePlusCommissionEmployee extends CommissionEmployee 
{
   ...
   public BasePlusCommissionEmployee( String first, String last, 
      String ssn, int month, int day, int year, int hmonth, int hday, int hyear,int cmonth,int cday,int cyear,boolean covid,
      double sales, double rate, double salary )
   {
      super( first, last, ssn, month, day, year,hmonth, hday, hyear,cmonth,cday,cyear,covid, sales, rate );
